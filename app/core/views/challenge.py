...
def _input_elements(challenge):
    ...
    for element_dict in elements.values():
        ...
        #element_dict["container_args"] = ever_given.wrapper.prepare_command_list("", args_dict)
        element_dict["container_args"] = " ".join(ever_given.wrapper.prepare_command_list("", args_dict))
